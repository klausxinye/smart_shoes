...
public class testBlueTooth extends Activity {
	...
	private Button btnSearch, btnDis, btnBack;
	...
	private void manageConnectedSocket() {
		...
		//testBlueTooth.this.setResult(RESULT_OK,testBlueTooth.this.getIntent());
		//testBlueTooth.this.finish();
		intent.setClass(testBlueTooth.this, userInfoActivity.class);
...
private	class ClickEvent implements View.OnClickListener {
		...
		public void onClick(View v) {
			if (v == btnSearch)// 搜索蓝牙设备，在BroadcastReceiver显示结果
			{
				...
				if (v == btnBack)// 搜索蓝牙设备，在BroadcastReceiver显示结果
				{
					{
					Intent intent = new Intent();
					intent.setClass(testBlueTooth.this,userInfoActivity.class);
